...
INSERT IGNORE INTO `sys_role` (`id`, `status`, `role_name`, `role_code`)
VALUES (1, 1, '超级管理员', 'SUPER_ADMIN'),
       (2, 1, '普通用户', 'USER');

INSERT IGNORE INTO `sys_permission` (`id`, `permission_name`, `permission_code`)
VALUES (1, '用户管理', 'system:user:manage'),
...
-- 用户名：admin
-- 密码：Admin@123456
INSERT IGNORE INTO `sys_user` (`id`, `username`, `password`, `status`, `email`,
...
INSERT IGNORE INTO `tag` (`id`, `tag_name`, `create_by`, `remark`)
VALUES (1, '数据结构', 'system', '开发环境初始化标签'),
...
INSERT IGNORE INTO `problem` (`id`, `problem_name`, `time_limit`, `memory_limit`,
...
VALUES (1, 'A+B Problem', 1000, 131072,
...
INSERT IGNORE INTO `problem_test_data` (`id`, `problem_id`, `version`, `test_node_count`,
                                        `archive_name`, `storage_path`, `archive_sha256`,
                                        `status`, `active`, `create_by`, `remark`)
VALUES (1, 1, 1, 3, 'p1-testdata-v1', 'D:/ProgramData/goj-data/testData/p1/v1', NULL, 'READY', 1, 'system',
        'seed test data directory'),
       (2, 2, 1, 3, 'p2-testdata-v1', 'D:/ProgramData/goj-data/testData/p2/v1', NULL, 'READY', 1, 'system',
        'seed test data directory'),
       (3, 3, 1, 3, 'p3-testdata-v1', 'D:/ProgramData/goj-data/testData/p3/v1', NULL, 'READY', 1, 'system',
        'seed test data directory'),
       (4, 4, 1, 3, 'p4-testdata-v1', 'D:/ProgramData/goj-data/testData/p4/v1', NULL, 'READY', 1, 'system',
        'seed test data directory'),
       (5, 5, 1, 3, 'p5-testdata-v1', 'D:/ProgramData/goj-data/testData/p5/v1', NULL, 'READY', 1, 'system',
        'seed test data directory'),
       (6, 6, 1, 3, 'p6-testdata-v1', 'D:/ProgramData/goj-data/testData/p6/v1', NULL, 'READY', 1, 'system',
        'seed test data directory');
...
INSERT IGNORE INTO `problem_tag` (`id`, `problem_id`, `tag_id`, `create_by`, `remark`)
VALUES (1, 1, 8, 'system', 'A+B Problem -> 数学'),
...
# 进行原始累加
INSERT INTO user_activity_day (user_id, activity_date, accepted_count)
VALUES (1, '2026-08-16', 1)
ON DUPLICATE KEY UPDATE accepted_count = accepted_count + 1;

# 进行原始累加
INSERT INTO `user_submission_status_stat` (`user_id`,
                                           `status`,
                                           `submission_count`,
                                           `create_by`)
VALUES (1,
